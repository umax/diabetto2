...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.carbohydrates'
        db.add_column(u'product_product', 'carbohydrates',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.carbohydrates'
        db.delete_column(u'product_product', 'carbohydrates')
